...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    Button btn_0,btn_1,btn_2,btn_3,btn_4,btn_5,btn_6,
            ...
            btn_sub,btn_add,btn_equ,btn_p,btn_factorial;
    // Button
    EditText text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_div = (Button) findViewById(R.id.btn_div); // 除法
        btn_div.setOnClickListener(this);

        btn_mul = (Button) findViewById(R.id.btn_mul); // 乘法
        btn_mul.setOnClickListener(this);

        btn_sub = (Button) findViewById(R.id.btn_sub); // 减法
        btn_sub.setOnClickListener(this);

        btn_add = (Button) findViewById(R.id.btn_add); // 加法
        btn_add.setOnClickListener(this);

        btn_factorial = (Button) findViewById(R.id.btn_factorial);  // 阶乘
        btn_factorial.setOnClickListener(this);

        btn_equ = (Button) findViewById(R.id.btn_equ); // 等于
